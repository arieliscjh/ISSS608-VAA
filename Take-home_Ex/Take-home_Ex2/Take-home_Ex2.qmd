...
```{r}
stu_qqq_3.1 <- stu_qqq_3_NO_NA %>%
  mutate(Math_Score_Range = cut(Math_Score, 
                                breaks = c(100, 200, 400, 600, 800, 1000), 
                                labels = c("100-200", "201-400", "401-600", 
                                           "601-800", "801-1000"),
                                include.lowest = TRUE),
         Science_Score_Range = cut(Science_Score, 
                                breaks = c(100, 200, 400, 600, 800, 1000), 
                                labels = c("100-200", "201-400", "401-600", 
                                           "601-800", "801-1000"),
                                include.lowest = TRUE),
         Reading_Score_Range = cut(Reading_Score, 
                                breaks = c(100, 200, 400, 600, 800, 1000), 
                                labels = c("100-200", "201-400", "401-600", 
                                           "601-800", "801-1000"),
                                include.lowest = TRUE))
...
p1<-ggplot(data = stu_qqq_3.1,
  ...
  geom_bar(width = 0.5,
           color = "grey30",
           fill = "white")+
  labs(y = "number of school") +
  ggtitle("Difference of academic performance among schools")+
...
combined_plot <- combined_plot + plot_layout(heights = c(7, 7, 7))
